...
QtObject {
    ...
    readonly property color gray320: "#343434"
    readonly property color gray330: "#333333"
    readonly property color gray340: "#2F2F2F"
    readonly property color gray350: "#515151"
    readonly property color gray355: "#595959"
    readonly property color gray360: "#232323"
    readonly property color gray370: "#1F1F1F"
    readonly property color gray390: "#A9A9A9"
    ...
    readonly property color gray500Opacity35: getColor(gray500, 0.35)
    readonly property color gray550Opacity07: getColor(gray550, 0.07)
    readonly property color gray550Opacity20: getColor(gray550, 0.2)
    ...
    readonly property color orange300Opacity40: getColor(orange300, 0.4)
    ...
    readonly property color red500Opacity40: getColor(red500, 0.4)
    ...
    readonly property color yellow400Opacity40: getColor(yellow400, 0.4)
    ...
    readonly property color green500Opacity40: getColor(green500, 0.4)
